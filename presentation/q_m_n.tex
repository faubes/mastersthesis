...
\begin{frame}{Gives four possible cases}
\begin{columns}[onlytextwidth, T]
\column{0.48\textwidth}
\begin{figure}
...
\begin{figure}
\includegraphics[height=0.3\textheight, keepaspectratio]{q_m_n/case_1_a_1}
\includegraphics[height=0.3\textheight, keepaspectratio]{q_m_n/case_1_a_2}

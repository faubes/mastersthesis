\begin{frame}{Games on Graphs}
  ...
  \begin{overlayarea}{\textwidth}{\textheight}
    \includegraphics<1>[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{intro/cops_and_robbers_1}
    \note<1>[item]{Graphs model networks, maps, relationships}

    \includegraphics<2>[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{intro/cops_and_robbers_2}
    ...
    \includegraphics<3>[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{intro/cops_and_robbers_3}
    ...
    \includegraphics<4>[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{intro/cops_and_robbers_4}
    ...
    \includegraphics<5>[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{intro/cops_and_robbers_5}
    ...
    \includegraphics<6>[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{intro/cops_and_robbers_6}

    \includegraphics<7>[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{intro/cops_and_robbers_7}

    \includegraphics<8>[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{intro/cops_and_robbers_8}

    \includegraphics<9>[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{intro/cops_and_robbers_9}

    \includegraphics<10>[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{intro/cops_and_robbers_10}
    ...
    \includegraphics<11>[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{intro/cops_and_robbers_11}
  \end{overlayarea}
\end{frame}
...
\begin{frame}{Zombies and Survivors}
  %\centering
  \begin{overlayarea}{\textwidth}{\textheight}
  \includegraphics<1>[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{intro/zombies_and_survivors_1}
  ...
  \includegraphics<2>[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{intro/zombies_and_survivors_2}
  \note[item]<2>{On their turn, zombies compute shortest path (geodesic) to survivor.}
  \includegraphics<3>[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{intro/zombies_and_survivors_3}
  ...
  \includegraphics<4>[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{intro/zombies_and_survivors_4}
  \includegraphics<5>[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{intro/zombies_and_survivors_5}
  \includegraphics<6>[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{intro/zombies_and_survivors_6}
  \includegraphics<7>[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{intro/zombies_and_survivors_7}
  \includegraphics<8>[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{intro/zombies_and_survivors_8}
  \includegraphics<9>[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{intro/zombies_and_survivors_9}
  \includegraphics<10>[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{intro/zombies_and_survivors_10}
  \includegraphics<11>[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{intro/zombies_and_survivors_11}
\end{overlayarea}
\end{frame}
...
\begin{columns}
  \column{0.48\textwidth}
    \begin{figure}
      \centering
      \includegraphics[width=0.8\textwidth, keepaspectratio]{copwin_tree/copwin_but_notzombie_win.pdf}
...
\begin{frame}{Cop-Number and Zombie-Number}
    \begin{figure}
      \includegraphics{intro/simple_graphs}
    \end{figure}

...
to $s$). Therefore the survivor can safely move onto another vertex of $C$ and, on the following round, move to an occupied vertex in $Q$. After
...
There are now at least three unthreatened vertices of $C$ for the survivor to choose. The survivor can choose any unthreatened vertex on
$C$.

Games played on cycles are straightforward: if the zombies are too close, the survivor can lead
...
\begin{figure}
  \centering
 \includegraphics[scale=0.5]{q_m_n/Q_7_8}
...
Unfortunately for the survivor, we are able to show
...
\begin{proofpart}
  ...
  \begin{figure}
    \centering
    \includegraphics[scale=0.65]{q_m_n/z2_path_Pa}

    \includegraphics[scale=0.65]{q_m_n/z2_path_Pb}

    \includegraphics[scale=0.65]{q_m_n/z2_path_Pc}

    \includegraphics[scale=0.65]{q_m_n/z2_path_Pd}
  ...
  \begin{figure}
    \centering
    \includegraphics[scale=0.65]{q_m_n/case_1_a_1}
  ...
  \begin{figure}
    \centering
    \includegraphics[scale=0.65]{q_m_n/case_1_a_2}
...
\begin{align*}
  ...
  \begin{figure}
    \centering
    \includegraphics[scale=0.65]{q_m_n/case_1_b_1}
  ...
  \begin{figure}
    \centering
    \includegraphics[scale=0.65]{q_m_n/case_1_b_2}
  ...
  \begin{figure}
    \centering
    \includegraphics[scale=0.65]{q_m_n/case_2_a_1}
  ...
  \begin{figure}
    \centering
    \includegraphics[scale=0.65]{q_m_n/case_2_a_2}
  ...
  \begin{figure}
    \centering
    \includegraphics[scale=0.65]{q_m_n/case_2_b_1}
  ...
  \begin{figure}
    \centering
    \includegraphics[scale=0.65]{q_m_n/case_2_b_2}
...
\section{Computing $\Delta$ and $k$ \label{thm q_m_n 4}}

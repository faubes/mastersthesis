...
\begin{proof}
 ...
 \begin{proofpart} Cornering the Survivor on the Smallest Cycle
  ...
  \begin{center}
    \includegraphics[scale=0.30]{q_m_n/z2_path_Pa}
    \includegraphics[scale=0.30]{q_m_n/z2_path_Pb}

    \includegraphics[scale=0.30]{q_m_n/z2_path_Pc}
    \includegraphics[scale=0.30]{q_m_n/z2_path_Pd}
  \end{center}

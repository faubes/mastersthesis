...
\begin{proof}
  ...
  %That is, after $\Delta$ rounds, both zombies (and the survivor) are on $C_{m+1}$ and the zombies %are not on an induced sub-path of length $\lfloor \frac{m}{2} \rfloor -2$.
...
\begin{description}
  ...
  \begin{figure}
    \centering
    \includegraphics[scale=0.75]{q_m_n/z2_path_Pa}
    \includegraphics[scale=0.75]{q_m_n/z2_path_Pb}

    \includegraphics[scale=0.75]{q_m_n/z2_path_Pc}
    \includegraphics[scale=0.75]{q_m_n/z2_path_Pd}
